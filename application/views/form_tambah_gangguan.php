	...
	<div class="row">
		...
		<section class="panel">
			...
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/gangguan/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input value="" id="id_gangguan" name="id_gangguan" type="hidden" >
			  	<div class="form-group">
				  <label class="col-sm-2 control-label">Tanggal Laporan</label>
				  <div class="col-sm-2">
					<input class="input-sm input-s form-control tanggal_laporan" size="16" type="text" data-date-format="yyyy-mm-dd hh:mm:ss" data-required="true" value="<?php echo date('Y-m-d G:i:s'); ?>"  name="tanggal_laporan">
				  </div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					<input class="form-control"  type="text"  data-required="true" value="" name="lokasi">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label">Kejadian</label>
				  <div class="col-sm-2">
					<?php echo $this->ckeditor->editor("kejadian","" );?>
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label">Tanggal Lanjutan</label>
				  <div class="col-sm-2">
					<input class="input-sm input-s form-control tanggal_lanjutan" size="16" type="text" data-date-format="yyyy-mm-dd hh:mm:ss" data-required="true" value="<?php echo date('Y-m-d G:i:s'); ?>"  name="tanggal_lanjutan">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label">lanjutan</label>
				  <div class="col-sm-2">
					<?php echo $this->ckeditor->editor("lanjutan","");?>
				  </div>
				</div>
