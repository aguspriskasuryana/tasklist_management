	...
	<div class="row">
		...
		<section class="panel">
			...
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/biaya/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input value="" id="id_biaya" name="id_biaya" type="hidden" >
			  <input value="" id="user_akses" name="user_akses" value="<?php echo $id['id_user'] ?>" type="hidden" >
				...
				<div class="form-group">
				  ...
				  <div class="col-lg-10">
					<input type="text" class="form-control" data-required="true" name="keterangans" value="">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-lg-2 control-label">Jumlah</label>
				  <div class="col-lg-10">
					<input type="text" class="form-control" data-required="true" name="jumlah" value="">
				  </div>
				</div>
				<div class="form-group">
