	...
	<div class="row">
		...
		<section class="panel">
			...
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/harian_operator/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input id="id_harian_operator" name="id_harian_operator" type="hidden" >
