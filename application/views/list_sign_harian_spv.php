	...
	<div class="row">
		<div class="col-md-12">
			<section class="panel">
				...
				<header class="panel-heading">
					<form action="<?php echo base_url('index.php/harian_spv/signHarianSPV'); ?>" method="post">
					...
					?>
						<tr>
							...
							if (isset($penerima[0])){
								...
								<form action="<?php echo base_url('index.php/harian_spv/signSupervisorHarianSPV'); ?>" method="post">
						...
						<tr>
							...
							if (isset($mengetahui[0])){
								...
								<form action="<?php echo base_url('index.php/harian_spv/signAppFinalHarianSPV'); ?>" method="post">
								<input type="hidden" value="<?php echo $tanggalselect;?>" name="tanggal">
								<input type="hidden" value="<?php echo $shiftselect;?>" name="shift">
							...
							<?php
							} else if ((isset($penerima[0]) && !(isset($mengetahui[0])) ) ){
								echo "Belum di Approve Kabag";
							} else {
