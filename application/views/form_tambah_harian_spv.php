...
<section class="scrollable wrapper">
	<div class="row">
		<div class="col-sm-12">
		<section class="panel">
			<header class="panel-heading font-bold">Form Tambah Harian SPV</header>
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/harian_spv/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input id="id_harian_spv" name="id_harian_spv" type="hidden" >
			  <div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					<input class="form-control"  type="text"  value="<?php echo date('Y-m-d G:i:s'); ?>"  data-required="true" name="waktu_lapor">
				  </div>
				</div>
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					<?php 
						...
						<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $users['id_user'];?>" <?php echo $checked;?> name="spv[]">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					<input class="form-control"  type="text"  value="<?php echo date('Y-m-d G:i:s'); ?>"  data-required="true" name="waktu_kejadian">
				  </div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					<input class="form-control"  type="text"  value=""  data-required="true" name="tindak_lanjut">
				  </div>
				</div>
