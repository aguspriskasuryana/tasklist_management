		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading">
					<a href="<?php echo site_url('form_storage_new/tambah_form_storage_new'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Barang Baru</a>
					<a href="<?php echo site_url('form_storage_new/get_list_form_storage_new'); ?>" class="btn btn-success btn-sm"><i class="fa fa-list"></i>Storage</a>
				...
				<div class="table-responsive">
					...
					<thead>
							<tr>
								...
								<th width="5%">SN</th>
								<th width="3%">Jml Keluar</th>
								<th width="3%">Tgl Keluar</th>
					...
					?>
						<tr>
							...
							<td><?php echo $list['jml_keluar']?></td>
							<td><?php echo $list['tgl_keluar']?></td>
