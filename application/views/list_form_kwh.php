		...
		<div class="col-md-12">
			<section class="panel">
				...
				*Untuk data KWH yang lebih lawas bisa menggunakan export excel
				...
				<form id="changetanggal" method="post" action="<?php echo site_url('form/getlistformkwhexcel'); ?>"  class="panel-body">
				...
				<div class="table-responsive">
					...
					?>
						<tr>
							...
							<td>
							<a class="fa fa-edit" data-target="#modal_kwh" data-toggle="modal" data-form_id=<?php echo $list['id_kwh']?>></a>

							<!--|| 
							<a href="<?php echo site_url('form/hapusformkwh/'.$list['id_kwh']); ?>" class="btn detail_icon btn-xs btn-danger btn_delete_form" data-toggle="tooltip" data-original-title="Delete Form"><i class="fa fa-trash-o"></i></a>
							-->
							</td>
...
<script language="JavaScript">
    $(document).ready(function() {
        $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {          
          	$.post('<?php echo site_url('form/modalformkwh'); ?>',
