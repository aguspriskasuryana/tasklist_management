...
<section class="scrollable wrapper">
	<div class="row">
		<div class="col-sm-12">
		<section class="panel">
			<header class="panel-heading font-bold">Form Search By Code
			...
			<div class="table-responsive">
					...
					?>
						<tr>
							...
							<?php
							$loc_detaillist = substr($list['LOC_DETAIL'],0,5);
							 if($loc_detaillist == $loc_detail){ ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		...
      		<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/inventory_tape/scan_inventory_tape'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
				...
				<label class="col-lg-2 control-label">Loc Detail</label>
					...
					<div class="dropdownx">
						<div id="myDropdownx" class="dropdownx-content">
						    <input type="text" placeholder="Search.." id="myInputx" name="loc_detail" value="<?php echo $loc_detail ?>" onkeyup="filterFunction()">

						    <?php 
								foreach($loc_detail_tbl as $loc_detail_tbls){ 
								?>

								<a href="#about" onclick="myFunctionclick('<?php echo $loc_detail_tbls['loc_detail'];?>')"><?php echo $loc_detail_tbls['loc_detail'];?></a>
							<?php 
								}
							?>
				...
				<label class="col-lg-2 control-label"></label>
					<div class="col-sm-8">
                            <p id="scanned-QRX"></p>
							<input type="hidden" class="form-control" id="scanned-QR" data-required="true" name="scanned-QR" 
							>
					 </div>	
				</div>
