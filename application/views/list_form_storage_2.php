		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading">
					<a href="<?php echo site_url('form_storage/tambah_form_storage'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah</a>
				...
				<div class="table-responsive">
					...
					?>
						<tr>
							<td><?php echo $list['id_form_storage']?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		...
      		<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/form_storage/get_list_form_storage2'); ?>" method="post">
