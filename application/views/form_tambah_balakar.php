...
<section class="scrollable wrapper">
	<div class="row">
		<div class="col-sm-6">
		<section class="panel">
			<header class="panel-heading font-bold">Form Tambah Balakar</header>
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/balakar/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input id="id" name="id" type="hidden" >
				<div class="form-group">
				  <label class="col-lg-2 control-label">Nama Balakar</label>
				  <div class="col-lg-10">
