				...
				<div class="table-responsive">
					...
					?>
						<tr>
							...
							<td>
							<?php //if(($id["id_role"]) ==3) { ?>
							<a href="<?php echo site_url('harian_operator/edit_harian_operator/'.$list['id_harian_operator']); ?>" class="btn detail_icon btn-xs btn-danger btn_edit_harian_operator" data-toggle="tooltip" data-original-title="Edit Harian operator"><i class="fa fa-edit"></i></a> 
							<a href="<?php echo site_url('harian_operator/hapus/'.$list['id_harian_operator']); ?>" class="btn detail_icon btn-xs btn-danger btn_delete_harian_operator" data-toggle="tooltip" data-original-title="Delete harian_operator"><i class="fa fa-trash-o"></i></a> 
							<?php //} ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah Anda Yakin Akan Menghapus Harian OPERATOR?
            </div>
...
$('.btn_delete_harian_operator').click(function(e){
	e.preventDefault();
					var c = alertify.confirm('Anda akan menghapus data ini, Lanjutkan?').set('onok', function(){ window.location.href = $(e.delegateTarget).attr('href');} );
});
</script>
