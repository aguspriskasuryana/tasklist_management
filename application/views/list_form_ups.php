			...
			<section class="panel">
				<header class="panel-heading">
					*Untuk data UPS yang lebih lawas bisa menggunakan export excel
					<form id="changetanggal" method="post" action="<?php echo site_url('form/getlistformupsexcel'); ?>"  class="panel-body">
				...
				<div class="table-responsive">
					...
					?>
						<tr>
							...
							?></td>
							<td>
							<a class="fa fa-edit" data-target="#modal_ups" data-toggle="modal" data-form_id=<?php echo $list['id_form_ups']?>></a>
...
<script language="JavaScript">
    $(document).ready(function() {
        $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
          	...
          	$.post('<?php echo site_url('form/modalformups'); ?>',
