	...
	<div class="row">
		...
		<section class="panel">
			...
			<div class="panel-body">
			  <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('index.php/form_storage_new/simpan_data'); ?>" method="post">
			  <?php echo $this->csrf->get_html(); ?>
			  <input id="id_form_storage_new" name="id_form_storage_new" type="hidden" >
